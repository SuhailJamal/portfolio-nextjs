...
const Aboutfooter = () => {
    ...
    return(
        <>
        {
            items.map((val, indx) => {
              return(
                <div className="p-1 w-fit relative hidden md:block"  key={indx}>
                <h1 className="gap-2 text-3xl font-poppins text-primary font-semibold relative flex icon_underline max-sm:text-xl">{val.icon}{val.name}</h1>
